...
void login()
{
  char userName[20] = "SHUBHAM BODKHE";
  char passWord[10] = "2407";
  char matchPass[10];
  char matchUser[10];
  int value;
  redColor();
...
void busLists()
{
  ...
  printf("-----------------------------------------------------------------------------------------");
  resetColor();
  printf("\n1\tGanga Travels       \tchinchwad to pune           \tRs.30      \t\t07:00 AM");
  printf("\n2\tShubham Travels     \tNigdi to chinchwadgoan      \tRs.20      \t\t09:00 AM");
  printf("\n3\tshiv Travels        \tchinchwaddgoan to bhosari   \tRs.50      \t\t11:00 AM");
  printf("\n4\tPCMC Travels        \tNigid to ShivajiNager       \tRs.25      \t\t01:30 PM");
  printf("\n5\tShree Travels       \tchinchwad to HA             \tRs.10      \t\t04:00 PM");
  printf("\n6\tSurya Travels       \tPune to Nigdi               \tRs.70      \t\t07:00 AM");
  printf("\n7\tMonu Travels        \tPune to Bhosari             \tRs.70      \t\t07:00 AM");
  printf("\n8\tGang Travels        \tPune to chinchwad           \tRs.70      \t\t07:00 AM");
  printf("\n9\tBasti Travels       \tNigdi to MA.N.PA            \tRs.70      \t\t07:00 AM");
  printf("\n");
